...
CREATE TABLE comentario (id BIGINT AUTO_INCREMENT, texto VARCHAR(140) NOT NULL, fecha DATE NOT NULL, noticia_id BIGINT NOT NULL, usuario_id BIGINT NOT NULL, PRIMARY KEY(id)) ENGINE = INNODB;
